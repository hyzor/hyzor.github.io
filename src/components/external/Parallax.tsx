// Ruthlessly copied from https://github.com/scottjr632/react-rellax-wrapper
// Author: Scott Richardson (https://github.com/scottjr632)

import React, { FC, useState, useRef, useEffect } from 'react';
import Rellax, { RellaxOptions } from 'rellax';

interface RellaxWrapperProps extends RellaxOptions {
  className?: string;
  zIndex?: number;
  percentage?: number;
  xs?: number;
